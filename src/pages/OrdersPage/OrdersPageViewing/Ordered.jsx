import { Link, useLoaderData, useNavigate, useSearchParams, defer, Await } from "react-router-dom"
						...
						<Await resolve={orders}>
							{
								(resolvedOrders) => (
									<>
										{resolvedOrders.filter(order => order.usr_id.includes(orderQuery)).map((order, index) => {
											return (
