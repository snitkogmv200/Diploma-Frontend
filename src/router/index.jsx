...
import OrdersPageViewing from "../pages/OrdersPage/OrdersPageViewing";
import { orderLoader, Ordered } from "../pages/OrdersPage/OrdersPageViewing/Ordered";

import WarehouseViewing from "../pages/Warehouses/WarehousePageViewing";

const routerCreate = createBrowserRouter(createRoutesFromElements(
	<Route path='/' element={<Layout></Layout>}>
		<Route index element={<HomePage></HomePage>}></Route>
		<Route path='order' element={<OrdersPageViewing></OrdersPageViewing>} loader={orderLoader}></Route>
		...
		<Route path='warehouse' element={<WarehouseViewing></WarehouseViewing>}></Route>
